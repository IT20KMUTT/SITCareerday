...
<body>
  ...
  <div class="br-mainpanel br-profile-page">
    ...
    <div class="card shadow-base bd-0 rounded-0 widget-4">
      ...
      <div class="card-body">
        <div class="card-profile-img">
          <img src="http://apollo.kmutt.ac.th/kmuttstdpic/default.aspx?&stdcode=57130500028" alt="">
        </div><!-- card-profile-img -->
        <h4 class="tx-normal tx-roboto tx-white">Songrit Keardphol</h4>
        <p class="mg-b-25">Information Technology</p>
    ...
    <div class="ht-70 bg-gray-100 pd-x-20 d-flex align-items-center justify-content-center shadow-base">
      <ul class="nav nav-outline active-info align-items-center flex-row" role="tablist">
        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#posts" role="tab">บัญชีผู้ใช้ของฉัน</a></li>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                <div class="row">
                  <div class="col-md-10">
                    <span class="card-text" style="color: #adb5bd"><h5>โปรไฟล์ของฉัน</h5></span>
                  </div>
          ...
          <div class="col-lg-8">
            <div class="card pd-20 pd-xs-30 shadow-base bd-0 mg-t-30">
              ...
              <div class="row row-xs">
                ...
                <div class="col-6 col-sm-4 col-md-3"><img src="http://via.placeholder.com/300x300" class="img-fluid" alt=""></div>
                <div class="col-6 col-sm-4 col-md-3 mg-t-10 mg-sm-t-0"><img src="http://via.placeholder.com/300x300" class="img-fluid" alt=""></div>
                <div class="col-6 col-sm-4 col-md-3 mg-t-10 mg-md-t-0"><img src="http://via.placeholder.com/300x300" class="img-fluid" alt=""></div>
          ...
          <div class="col-lg-4 mg-t-30 mg-lg-t-0">
            <div class="card pd-20 pd-xs-30 shadow-base bd-0 mg-t-30">
              ...
              <div class="row row-xs mg-b-15">
                <div class="col"><img src="http://via.placeholder.com/300x300" class="img-fluid" alt=""></div>
                <div class="col"><img src="http://via.placeholder.com/300x300" class="img-fluid" alt=""></div>
                <div class="col">
                  <div class="overlay">
                    <img src="http://via.placeholder.com/300x300" class="img-fluid" alt="">
  ...
  $(document).ready(function(){
    ...
    rootRef.on('value', function(snapshot) {
      ...
      $('#birth').val(snapshot.val().birth) ;
      $('#sodier').val(snapshot.val().sodier) ;

      $('#prefixUPD').val(snapshot.val().prefix);
      $('#nameUPD').val(snapshot.val().name) ;
      $('#surnameUPD').val(snapshot.val().surname) ;
      $('#ageUPD').val(snapshot.val().age) ;
      $('#religionUPD').val(snapshot.val().religion) ;
      $('#birthUPD').val(snapshot.val().birth) ;
      $('#sodierUPD').val(snapshot.val().sodier) ;
    });
  });
      ...
      buttons: {
        ยืนยัน: {
          ...
          action: function () {
            ...
            var postData = {
              prefix: $('#prefixUPD').val(),
              name: $('#nameUPD').val(),
              surname: $('#surnameUPD').val(),
              age: $('#ageUPD').val(),
              religion: $('#religion').val(),
              birth: $('#birthUPD').val(),
              sodier: $('#sodierUPD').val(),
            };
