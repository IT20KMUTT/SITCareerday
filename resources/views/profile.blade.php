  ...
  <body>
    ...
    <div class="br-mainpanel br-profile-page">
      ...
      <div class="card shadow-base bd-0 rounded-0 widget-4">
        <div class="card-header ht-75" style="background-color: #3399cc;">
            <button class="btn btn-warning"><i class="fa fa-send mg-r-10"></i> แก้ไขข้อมูลส่วนตัว</button>
        </div><!-- card-header -->
        <div class="card-body">
            ...
            <div class="col-lg-8">
              <div class="media-list bg-white rounded shadow-base">
                <div class="media pd-20 pd-xs-30">
                  <img src="http://via.placeholder.com/300x300" alt="" class="wd-40 rounded-circle">
              ...
              <div class="card pd-20 pd-xs-30 shadow-base bd-0 mg-t-30">
                ...
                <div class="media-list">
                  <div class="media align-items-center pd-b-10">
                    <img src="http://via.placeholder.com/300x300" class="wd-45 rounded-circle" alt="">
